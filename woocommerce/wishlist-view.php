    ...
    <thead>
        <tr>
            ...
            <th class="product-name">
                <span class="nobr">
                    <?php echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_name_heading', __( 'Product name', 'qreate' ), $wishlist ) ); ?>
                </span>
            </th>
            ...
            <th class="product-price">
                <span class="nobr">
                    <?php echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_price_heading', __( 'Unit price', 'qreate' ), $wishlist ) ); ?>
                </span>
            </th>
            <?php endif; ?>
            ...
            <th class="product-quantity">
                <span class="nobr">
                    <?php echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_quantity_heading', __( 'Quantity', 'qreate' ), $wishlist ) ); ?>
                </span>
            </th>
            <?php endif; ?>
            ...
            <th class="product-stock-status">
                <span class="nobr">
                    <?php echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_stock_heading', __( 'Stock status', 'qreate' ), $wishlist ) ); ?>
                </span>
            </th>
            <?php endif; ?>
            ...
            <th class="product-arrange">
                <span class="nobr">
                    <?php echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_arrange_heading', __( 'Arrange', 'qreate' ), $wishlist ) ); ?>
                </span>
            </th>
            <?php endif; ?>
        </tr>
	...
	if ( $wishlist && $wishlist->has_items() ) :
        ...
        <tr id="yith-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>"
            ...
            <td class="product-remove">
                <div>
                    <a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item->get_product_id() ) ); ?>"
                        ...
                        title="<?php echo esc_html( apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'qreate' ) ) ); ?>">&times;</a>
                </div>
            </td>
            <?php endif; ?>
            ...
            <td class="product-stock-status">
                ...
                <?php echo 'out-of-stock' === $stock_status ? '<span class="wishlist-out-of-stock">' . esc_html( apply_filters( 'yith_wcwl_out_of_stock_label', __( 'Out of stock', 'qreate' ) ) ) . '</span>' : '<span class="wishlist-in-stock">' . esc_html( apply_filters( 'yith_wcwl_in_stock_label', __( 'In Stock', 'qreate' ) ) ) . '</span>'; ?>
            ...
            <td class="product-add-to-cart">
                ...
                <?php
							if ( $show_dateadded && $item->get_date_added() ) :
								...
								echo '<span class="dateadded">' . esc_html( sprintf( __( 'Added on: %s', 'qreate' ), $item->get_date_added_formatted() ) ) . '</span>';
							endif;
							?>
                ...
                <select class="change-wishlist selectBox">
                    <option value=""><?php esc_html_e( 'Move', 'qreate' ); ?></option>
                    <?php
                ...
                <a href="#move_to_another_wishlist" class="move-to-another-wishlist-button"
                    ...
                    <?php echo esc_html( apply_filters( 'yith_wcwl_move_to_another_list_label', __( 'Move to another list &rsaquo;', 'qreate' ) ) ); ?>
                </a>
                <?php endif; ?>
                ...
                <a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item->get_product_id() ) ); ?>"
                    class="remove_from_wishlist qreate-button"
                    title="<?php echo esc_html( apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'qreate' ) ) ); ?>">
                    <span class="qreate-text"> <?php esc_html_e( 'Remove', 'qreate' ); ?><span class="qreate-strip"></span></span>
                </a>
                <?php endif; ?>
        ...
        <tr>
            <td colspan="<?php echo esc_attr( $column_count ); ?>" class="wishlist-empty">
                <?php echo esc_html( apply_filters( 'yith_wcwl_no_product_to_remove_message', __( 'No products added to the wishlist', 'qreate' ), $wishlist ) ); ?>
            </td>
        </tr>
        <?php
	endif;
	...
	if ( ! empty( $page_links ) ) :
        ...
        <tr class="pagination-row wishlist-pagination">
            <td colspan="<?php echo esc_attr( $column_count ); ?>">
                <?php echo esc_html($page_links); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></td>
        </tr>
        <?php endif ?>
    </tbody>
