...
<!-- add to cart button -->
		...
		<button type="submit" class="qreate-button single_add_to_cart_button alt">
		<span class="qreate-text"><?php echo esc_html( $product->single_add_to_cart_text() ); ?><span class="qreate-strip"></span></span>
		</button>
