		...
		<div class="wishlist-title-container">
			<div class="wishlist-title <?php echo esc_attr( $can_user_edit_title ) ? 'wishlist-title-with-form' : ''; ?>">
				...
				<?php if ( $can_user_edit_title ) : ?>
					<!-- edit title button -->
					<a class="btn qreate-button show-title-form">
						...
						<span class="qreate-text"><?php esc_html_e( 'Edit title', 'qreate' ); ?><span class="qreate-strip"></span></span>
					</a>
				<?php endif; ?>
			</div>
			<?php if ( $can_user_edit_title ) : ?>
				<div class="hidden-title-form">
					...
					<div class="edit-title-buttons">
						<a role="button" href="#" class="hide-title-form">
							<?php echo apply_filters( 'yith_wcwl_cancel_wishlist_title_icon', '<i class="fa fa-times"></i>' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
						</a>
