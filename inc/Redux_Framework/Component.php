...
namespace qreate\qreate\Redux_Framework;
...
class Component implements Component_Interface {
	...
	protected $opt_name = "qreate-options";
	/**
	...
	public function action_add_redux(){
		...
		$args = array(
			...
			'menu_title'           => esc_html__( 'Qreate','qreate'),
			'page_title'           => esc_html__( 'Qreate','qreate'),
