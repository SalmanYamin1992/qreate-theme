<?php
/**
 * qreate\qreate\Customizer\Component class
 *
 * @package qreate
 */

namespace qreate\qreate\Customizer;
...
class Component implements Component_Interface {
	...
	public function action_enqueue_customize_preview_js() {
		wp_enqueue_script(
			...
			array( 'jquery' ),
			qreate()->get_asset_version( get_theme_file_path( '/assets/js/customizer.min.js' ) ),
			true
		);
	}
}
