...
/**
 * qreate\qreate\Sidebars\Component class
 *
 * @package qreate
 */

namespace qreate\qreate\Sidebars;
 ...
 * * `qreate()->is_primary_sidebar_active()`
 * * `qreate()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface
{
	...
	public function action_register_sidebars()
	{
		register_sidebar(
			array(
				'name' => esc_html__('Blog Sidebar', 'qreate'),
				'id' => static::PRIMARY_SIDEBAR_SLUG,
				'description' => esc_html__('Add widgets here.', 'qreate'),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget'  => '</div>',
				'before_title' => '<h5 class="widget-title"><span class="title">',
				'after_title' => '</span><span class="line wow"></span></h5>',
			)
		);
