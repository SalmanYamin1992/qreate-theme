<?php
/**
 * qreate\qreate\Nav_Menus\Component class
 *
 * @package qreate
 */

namespace qreate\qreate\Nav_Menus;
 ...
 * * `qreate()->is_primary_nav_menu_active()`
 * * `qreate()->display_primary_nav_menu( array $args = array() )`
 */
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_nav_menus() {
		register_nav_menus(
			array(
				static::PRIMARY_NAV_MENU_SLUG => esc_html__( 'Primary', 'qreate' ),
			)
		);
	}
