<?php
/**
 * qreate\qreate\Scripts\Component class
 *
 * @package qreate
 */

namespace qreate\qreate\Scripts;
...
class Component implements Component_Interface {
	...
	public function action_enqueue_scripts() {
		...
		foreach ( $js_files as $handle => $data ) {
			...
			$version = qreate()->get_asset_version( $js_dir . $data['file'] );
